...
- 场景采用 3/4 伪等距、32 像素基础网格、约 2.5 头身角色与四方向动画。
...
- Visuals use a 3/4 pseudo-isometric view, a 32-pixel base grid, approximately 2.5-head-tall characters, and four-direction animation.
